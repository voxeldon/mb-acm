...
const LANG_KEY = {
    ...
    HELP_MSG: RawText.MESSAGE(RawText.TRANSLATE(`${DATA_PREFIX}.help_header`), RawText.TEXT("\n\n"), RawText.TRANSLATE(`${DATA_PREFIX}.help_help`), RawText.TEXT("\n\n"), RawText.TRANSLATE(`${DATA_PREFIX}.help_start`), RawText.TEXT("\n\n"), RawText.TRANSLATE(`${DATA_PREFIX}.help_tool`), RawText.TEXT("\n\n"), RawText.TRANSLATE(`${DATA_PREFIX}.help_show`), RawText.TEXT("\n\n"), RawText.TRANSLATE(`${DATA_PREFIX}.help_footer`), RawText.TEXT("\n\n")),
};
export { LANG_KEY, DATA_PREFIX, PACK_ID, GAME_TOOL };
